<h2><a href="https://practice.geeksforgeeks.org/problems/number-of-occurrence2259/1?page=1&difficulty[]=-2&difficulty[]=-1&status[]=unsolved&category[]=Arrays&category[]=prefix-sum&sortBy=submissions">Number of occurrence</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sorted array <strong>Arr&nbsp;</strong>of size <strong>N </strong>and a number <strong>X</strong>, you need to find the number of occurrences of<strong> X</strong> in <strong>Arr</strong>.</span></p>
